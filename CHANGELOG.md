...
- Auch die längste Streak (Statistik), der Streak-Bonus und der „Heart of Stories"-Bonus für die erste Sitzung des Tages rechnen beim Speichern einer Sitzung jetzt nach dem lokalen Kalendertag statt nach UTC — bisher nur die aktuelle Streak. Für Nutzer außerhalb von UTC konnte die längste Streak dadurch von der aktuellen abweichen, und eine über die UTC-Mitternacht laufende Sitzung wurde fälschlich als neuer Streak-/Bonus-Tag gewertet.
- Eingabevalidierung greift jetzt auch beim Bearbeiten einer Lesesitzung und einer Pflanze, beim Pflanzenkauf sowie beim Buch-Massenimport. Zuvor prüften nur die Anlege- und die primären Bearbeiten-Pfade, sodass ungültige Daten (z. B. leere Pflanzennamen, Bücher ohne Titel) über diese Wege ungeprüft gespeichert werden konnten; ein einzelnes ungültiges Buch bricht den Import jetzt ab, statt teilweise zu importieren. (Der Timer-Abschluss kurzer/seitenbasierter Sitzungen bleibt bewusst ungeprüft, da dort 0-Minuten-Sitzungen legitim sind.)
- Das Zurücksetzen der Fortschritts-Werte (Münzen/XP/Level) beim „Alle Daten löschen" läuft jetzt über den serialisierten Einstellungs-Schreibpfad statt direkt am Schreib-Gate vorbei — so kann eine gleichzeitige Münz-/XP-Gutschrift nicht mehr mit dem Reset kollidieren.
- Das Hintergrund-Ereignis für den App-Update-Status hat jetzt — wie die Billing- und Onboarding-Ereignisse — eine eigene Fehlerbehandlung und kann den auslösenden Aufrufer nicht mehr durch eine unbehandelte Ausnahme stören.
