...
/// <summary>A plant species available in the shop.</summary>
public class PlantSpecies
{
    ...
    [Range(0, 1000000)]
    public int BaseCost { get; set; } = 100; // Cost in coins.

    public bool IsAvailable { get; set; } = true;

    [Range(1, 100)]
    public int UnlockLevel { get; set; } = 1; // Required user level to unlock.
    ...
    /// <summary>
    /// True if purchasable by Free-tier users (one of the 4 starter plants). Plus unlocks
    /// everything that is not <see cref="IsPrestigeTier"/>.
    /// </summary>
    public bool IsFreeTier { get; set; } = false;

    /// <summary>True for Premium-exclusive prestige plants (Chronicle Tree, Eternal Phoenix Bonsai).</summary>
